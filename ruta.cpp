...
namespace bblProgII{
	...
	Ruta::Ruta():origen(""),destino(""),linea_aerea(""),precio(0.0),duracion(0){}
	...
	Ruta::Ruta(const std::string &origen_ini,
	     ...
	     const std::string &linea_aerea_ini): origen(origen_ini),destino(destino_ini),linea_aerea(linea_aerea_ini),precio(precio_ini),duracion(duracion_ini){}
	...
	string Ruta::consultar_origen() const{
	...
	string Ruta::consultar_destino() const{
	...
	string Ruta::consultar_linea_aerea() const{
