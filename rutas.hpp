...
private:
	// ATRIBUTOS: A COMPLETAR POR EL ALUMNO
        struct Nodo;
        typedef Nodo * Lista; //Puntero a Nodo;
        struct Nodo{
            Ruta ruta;
            Lista sig;
        ...
        Lista lista; //Puntero externo enlazado a la lista enlazada de rutas
	...
	void insertar_final(const Ruta &ruta);

	Lista buscar_ruta(const Ruta &ruta)const;
